...
export const metadata = {
  title: 'Used Tires | Eastcord Tires Milton ON',
  description: 'Quality inspected used tires in Milton, Ontario. Affordable used tires for all makes and models.',
}
  ...
  return (
    <main className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center py-24 px-4">
      <div className="text-center max-w-2xl">
        ...
        {/* TODO: add used tire inventory/listings */}
        <Link
          href="/"
